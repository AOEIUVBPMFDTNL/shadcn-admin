      ...
      <div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-4'>
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>{t('totalClicksDelta')}</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>{t('uniqueVisitorsDelta')}</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>{t('bounceRateDelta')}</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>{t('avgSessionDelta')}</p>
          </CardContent>
        </Card>
      </div>
